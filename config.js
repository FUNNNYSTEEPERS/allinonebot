module.exports = {
  bot: {
    prefix: "p!", //Bot Prefix
    owners: ["707996717802324008"], //Bot Onwer ID
    maintenance: false,
    invite:
      "https://discord.com/api/oauth2/authorize?client_id=957210430546255892&permissions=8&scope=bot", //Link Invite Bot
    bot_add_description:
    ...
    // here the mongo for you : ||mongodb+srv://099:099@cluster0.kjeqb.mongodb.net/myFirstDatabase?retryWrites=true&w=majority|| paste it in .env Name as Mongo
  },
  status: {
    stats: "online", //Status Bot <idle, online, dnd , invisible>
    type: "watching", //Playing Bot <PLAYING, WATCHING , and others>
    name: "Neon|Developement" //Status Playing
  ...
  server: {
    id: "936511306306039818", //Server ID
    invite: "https://discord.gg/H5HssNGV" //Server Support
  },
  image: {
    welcome:
    ...
    help:
      "https://media.discordapp.net/attachments/953991898534654032/957212304561299516/standard_1.gif?width=374&height=48", //Image Cmd Help.js
    guild_add:
